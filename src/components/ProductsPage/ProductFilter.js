            ...
            <div className="col-10 mx-auto">
              <FilterWrapper>
                ...
                <div>
                  ...
                  <input className='filter-item' type="text" name="search" id='search' onChange={handleChange} value={search} />
                </div>           
                {/* end text search */}
                {/* category search */}
                  <div>
                    <label htmlFor="company">marca</label>
                ...
                {/* price range */}
                  <div>
                    <label htmlFor="price">
                      <p className="mb-2">produto preço : <span>$ {price}</span></p>
                    </label>
                ...
                {/* free shipping */}
                  <div>
                    <label htmlFor="shipping" className='mx-2'>Frete gratuito</label>
